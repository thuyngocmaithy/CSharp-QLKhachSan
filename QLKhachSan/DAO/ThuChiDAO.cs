    ...
    public class ThuChiDAO : DBConnect
    {
        ...
        public bool ThemThuChi(ThuChiDTO tc)
        {
            try
            {
                ...
                //Sai thứ tự sql
                //Bớt báo lại
                string SQL = string.Format("INSERT INTO PhieuThuChi VALUES ('{0}', '{1}', '{2}', '{3}', '{4}')", tc.MaPhieuThuChi, tc.ThoiGian, tc.LoaiHinh, tc.SoTien, tc.NoiDung);
        ...
        public bool SuaThuChi(ThuChiDTO tc)// Kho chứ không phải loại phòng
        {
            try
            {
                ...
                string SQL = string.Format("UPDATE PhieuThuChi SET ThoiGian = '{0}', LoaiHinh = '{1}', SoTien = '{2}', NoiDung = '{3}' WHERE MaPhieuThuChi = '{4}'", tc.ThoiGian, tc.LoaiHinh, tc.SoTien, tc.NoiDung, tc.MaPhieuThuChi);
